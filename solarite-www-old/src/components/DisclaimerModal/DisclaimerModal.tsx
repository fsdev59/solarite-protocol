...
const DisclaimerModal: React.FC<DisclaimerModal> = ({ onConfirm, onDismiss }) => {
  ...
  const modalContent = useMemo(() => {
    if (step === 'disclaimer') {
      ...
      return (
        <div>
          <p>Attention SOLARITE Uniswap LPs</p>
          <p>The only Uniswap pool that is compatible with SOLARITE is SOLARITE/yCRV (Curve yPool tokens)</p>
